...
X_train, X_val, y_train, y_val = train_test_split(train_data['tweet'], train_data['sarcastic'], test_size=0.2)
...
print(classification_report(test_data['sarcastic'], y_pred))
